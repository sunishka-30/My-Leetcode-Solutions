<h2><a href="https://leetcode.com/problems/sum-of-subarray-minimums/">907. Sum of Subarray Minimums</a></h2><h3>Medium</h3><hr><div style="user-select: auto;" data-read-aloud-multi-block="true"><p style="user-select: auto;">Given an array of integers arr, find the sum of <code style="user-select: auto;">min(b)</code>, where <code style="user-select: auto;">b</code> ranges over every (contiguous) subarray of <code style="user-select: auto;">arr</code>. Since the answer may be large, return the answer <strong style="user-select: auto;">modulo</strong> <code style="user-select: auto;">10<sup style="user-select: auto;">9</sup> + 7</code>.</p>
